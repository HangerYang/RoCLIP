...
def parse_args():
    ...
    parser.add_argument("--cross_lr", type = float, default = 0.0005, help = "Learning rate")
    parser.add_argument("--in_lr", type = float, default = 0.0005, help = "Learning rate")
    parser.add_argument("--filter_lr", type = float, default = 1e-5, help = "Learning rate")
    ...
    parser.add_argument("--inmodal_warmup", type = int, default = 0, help = "number of epochs for inmodal pretraining")
    parser.add_argument("--multimodal_warmup", type = int, default = 0, help = "number of epochs for multimodal pretraining")
