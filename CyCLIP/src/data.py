...
def get_eval_test_dataloader(options, processor):
    ...
    if(options.eval_data_type == "Caltech101"):
        ...
        dataset = torchvision.datasets.StanfordCars(root = os.path.dirname("/home/hyang/NNCLIP/CyCLIP/data/stanford_cars"), download = True, split = "test", transform = processor.process_image)
...
def get_eval_train_dataloader(options, processor):
    ...
    if(options.eval_data_type == "Caltech101"):
        ...
        dataset = torchvision.datasets.StanfordCars(root = os.path.dirname("/home/hyang/NNCLIP/CyCLIP/data/stanford_cars"), download = True, split = "train", transform = processor.process_image)
    elif(options.eval_data_type == "STL10"):
